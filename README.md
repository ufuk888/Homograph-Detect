...
**HomographDetect** is a deceptive phishing method where cyber attackers direct users to fake domains or e-mails by using visually identical characters from different alphabets (for example, the "a" in the Latin alphabet and the "а" in the Cyrillic alphabet).
...
👉 [HomographDetect Live Demo](https://ufukbabasiz.github.io/HomographDetect/)
